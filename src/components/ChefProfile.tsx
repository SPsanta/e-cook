...
export function ChefProfile({ chef, onBack, onAddToCart }: ChefProfileProps) {
  const chefDishes: Dish[] = [
    ...
    },
    {
      ...
      tags: ['итальянское', 'ризотто'],
      description: 'Кремовое ризотто с лесными грибами',
      ingredients: ['Рис арборио', 'Грибы', 'Пармезан', 'Бульон', 'Лук']
    },
    {
      id: '3',
      name: 'Тирамису',
      ...
      tags: ['десерт', 'итальянское'],
      description: 'Классический итальянский десерт',
      ingredients: ['Яйца', 'Сахар', 'Маскарпоне', 'Кофе', 'Печенье савоярди']
    }
  ];
